...
export class OracleDatabase implements DatabaseAdapter {
	...
	public async getBlockTransactions(options: BlockTransactionQuery): Promise<Transaction[]> {
	...
	public async getTransactions(options: TransactionQuery): Promise<Transaction[]> {
